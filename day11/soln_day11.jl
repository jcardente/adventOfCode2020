# ------------------------------------------------------------
# Solution to Advent of Code 2020 Puzzle Day 11
#
# PUZZLE:
#
...
function seatmapPrint(seatmap)
  nrow, ncol = size(seatmap)
  for i in 2:(nrow-1)
    println(join(seatmap[i, 2:(ncol-1)], ""))
  end
end
...
function main()  
  ...
  #@printf("Seatmap after %d iterations:\n", iters)
  #seatmapPrint(seatmap)
